import { director, Color, view, Vec2, AudioClip, View, AudioSourceComponent, UITransform, Event, Node, Canvas } from "cc";
...
export class GRoot extends GComponent {
    ...
    public static create(canvas:Canvas = undefined): GRoot {
